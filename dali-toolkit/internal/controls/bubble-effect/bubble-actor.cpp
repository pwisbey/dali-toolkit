...
void BubbleActor::MakeRenderable( Geometry geometry, Material material  )
{
  ...
  mIndicesOffset[1] = mActor.RegisterProperty( "uOffset[1]", Vector2( rand_r( &seed ) % offset,  rand_r( &seed ) % offset ) );
  mIndicesOffset[2] = mActor.RegisterProperty( "uOffset[2]", Vector2( rand_r( &seed ) % offset, -rand_r( &seed ) % offset ) );
  mIndicesOffset[3] = mActor.RegisterProperty( "uOffset[3]", Vector2(-rand_r( &seed ) % offset,  rand_r( &seed ) % offset ) );
  mIndicesOffset[4] = mActor.RegisterProperty( "uOffset[4]", Vector2(-rand_r( &seed ) % offset, -rand_r( &seed ) % offset ) );
  mIndicesOffset[5] = mActor.RegisterProperty( "uOffset[5]", Vector2( rand_r( &seed ) % offset, 0.f ) );
  mIndicesOffset[6] = mActor.RegisterProperty( "uOffset[6]", Vector2(-rand_r( &seed ) % offset, 0.f ) );
  mIndicesOffset[7] = mActor.RegisterProperty( "uOffset[7]", Vector2( 0.f,  rand_r( &seed ) % offset ) );
  mIndicesOffset[8] = mActor.RegisterProperty( "uOffset[8]", Vector2( 0.f, -rand_r( &seed ) % offset ) );
...
void BubbleActor::SetMovementArea( const Vector2& movementArea )
{
  ...
  mActor.SetProperty( mIndicesOffset[1], Vector2( rand_r( &seed ) % offset,  rand_r( &seed ) % offset ) );
  mActor.SetProperty( mIndicesOffset[2], Vector2( rand_r( &seed ) % offset, -rand_r( &seed ) % offset ) );
  mActor.SetProperty( mIndicesOffset[3], Vector2(-rand_r( &seed ) % offset,  rand_r( &seed ) % offset ) );
  mActor.SetProperty( mIndicesOffset[4], Vector2(-rand_r( &seed ) % offset, -rand_r( &seed ) % offset ) );
  mActor.SetProperty( mIndicesOffset[5], Vector2( rand_r( &seed ) % offset, 0.f ) );
  mActor.SetProperty( mIndicesOffset[6], Vector2(-rand_r( &seed ) % offset, 0.f ) );
  mActor.SetProperty( mIndicesOffset[7], Vector2( 0.f,  rand_r( &seed ) % offset ) );
  mActor.SetProperty( mIndicesOffset[8], Vector2( 0.f, -rand_r( &seed ) % offset ) );
}
